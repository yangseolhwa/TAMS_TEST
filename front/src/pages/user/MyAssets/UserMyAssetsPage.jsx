...
import { InfoCircleFill, PlusCircleFill, DashCircleFill } from 'react-bootstrap-icons'
                  ...
                  <div className={styles.requestCardHeader}>
                    ...
                    <div className={styles.radioGroup}>
                      <label className={styles.radioLabel}>
                        <input type="radio" name={`assetType${index}`} value="existing" defaultChecked />
                        기존 자산
                      </label>
                      <label className={styles.radioLabel}>
                        <input type="radio" name={`assetType${index}`} value="new" />
                        신규 자산
                      </label>
                    </div>
                  </div>
                  ...
                  <div className={styles.selectRow}>
                    ...
                    <div className={styles.selectGroup}>
                      ...
                      <select
                        ...
                        onChange={(e) => handleAssetCategoryChange(index, e.target.value)}
                      ...
                      <div className={styles.selectRow}>
                        <div className={styles.selectGroup}>
                          ...
                          <select
                            ...
                            onChange={(e) => handleItemChange(index, 'swManufacturer', e.target.value)}
                          >
                            <option value="">선택</option>
                          </select>
                        </div>
                        <div className={styles.selectGroup}>
                          ...
                          <select
                            className={styles.select}
                            value={item.swName}
                            onChange={(e) => handleItemChange(index, 'swName', e.target.value)}
                          >
                            <option value="">선택</option>
                          </select>
                        </div>
                        <div className={styles.selectGroup}>
                          ...
                          <select
                            ...
                            onChange={(e) => handleItemChange(index, 'subscription', e.target.value)}
                          >
                            <option value="">선택</option>
                        ...
                        {item.licenseKeys.map((key, keyIndex) => (
                          <div key={keyIndex} className={styles.licenseKeyRow}>
                            <input
                              ...
                              value={key}
                              onChange={(e) => handleLicenseKeyChange(index, keyIndex, e.target.value)}
                            />
                            {keyIndex >= 1 && (
                              <button
                                className={styles.removeKeyBtn}
                                onClick={() => handleRemoveLicenseKey(index, keyIndex)}
                              >
